...
var num = 7;
const ageToVote = 18;        // age ToVote lower camel case 
let x = 5; 
let y = 7; 
...
newEngland.push("New York");      // Adds new elemnts to the end pf an array, and returns the new 
newEngland.pop();                 // Removes the last element pf an arrag, and returns that element 
newEngland.indexOf("Rhode Island", 0);  // Search the array for an element and retirns its posit 